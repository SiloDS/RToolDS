...
def Load_Defaults( Version ):
    if Version < 1: # No Config File so set Version 1 Defaults
        ...
        Config ["Columns"] = ["Icon", "Release Number", "Name", "Size", "Trimmed", 
                              ...
                              "Publisher", "Internal Name", "Serial", "Version", "Wifi", "Tags" ]
        ...
        Config ["CartColumn_Sizes"]  = {"Icon":36, "Release Number":37, "Name":265, "Size":53, 
                                        ...
                                        "Internal Name":105, "Serial":99, "Version":27, "Wifi":37, "Tags":12 }
        Config ["Languages"] = {
                0:_("All Languages"), 
                1:_("French"), 
                2:_("English"), 
...
#                16384:"English (UK)", 
    ...
    if Version < 3:
        Config ["Devices"] = [
                                ...
                                ["DS-Xtreme (.sav)", Utils.Device_Generic_256],
                                ["EZFlash IV (.sav)", Utils.Device_Generic_256],
                                ["EZFlash V (.sav)", Utils.Device_Generic_256],
                                ...
                                ["NinjaPass x9 (.sav)", Utils.Device_Generic_256],
                                ["R4 Revolution (.sav)", Utils.Device_R4_512],
                                ["SuperCard SD (.sav)", Utils.Device_Generic_256],
                                ["SuperCard DS One (.sav)", Utils.Device_Generic_256]
                             ]
