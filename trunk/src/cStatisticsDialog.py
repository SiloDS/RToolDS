...
#        SummaryText += "Scene Dat File Date : %s\n\n" % (time.strftime( "%d/%m/%Y %I:%M:%S %p", time.localtime( os.path.getmtime ( Config.Config ["AllXMLFilename"] ) ) ).lower())
        ...
        SummaryText += _("Total Offical ROMs") + " : %d\n" % (MyROMS.Current_Count - UnknownCount)
        SummaryText += _("Offical Game ROMs") + " : %d\n" % (MyROMS.Current_Count - UnknownCount - MyXXXX)
        SummaryText += _("Offical Demo ROMs") + " : %d\n" % (MyXXXX)
        SummaryText += _("Unknown ROMs") + " : %d\n\n" % (UnknownCount)
        SummaryText += _("Official ROMS Missing : %d of which %d are Demo (XXXX) ROMs") % (MyROMS.Master_List_Count - MyROMS.Current_Count, len (XXXX)) + "\n\n"
