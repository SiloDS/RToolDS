...
#        self.Freeze()
        ...
        SaveGameManager_Panel_Sizer.Add(self.Copy_Button, 0, 0, 1)
        SaveGameManager_Panel_Sizer.Add(self.Edit_Button, 0, 0, 1)
        SaveGameManager_Panel_Sizer.Add(self.Delete_Button, 0, 0, 1)
        SaveGameManager_Panel_Sizer.Add(self.Duplicate_Button, 0, 0, 1)
        SaveGameManager_Panel_Sizer.Add(self.Convert_Saves_Button, 0, 0, 1)
        SaveGameManager_Panel_Sizer.Add(self.Delete_All_Button, 0, 0, 0)
...
#            print self.SGMTreeCtrl.IsVisible(Hilight)
    ...
    def On_Copy( self, event ): # wxGlade: cSaveGameManager.<event_handler>
        ...
        if CRC not in self.Parent.Device_List.Get_CRC_List():
            wx.MessageBox( _( 'ROM is not on Device!' ), _( 'Error' ), wx.OK | wx.ICON_EXCLAMATION )
            return
...
#            SaveFileOut = open ( Utils.Get_Savename_on_Device ( ROM ), "wb" )
            ...
            wx.MessageBox( _( "Save Game Has Not Copied" ), _( 'Failed' ), wx.OK| wx.ICON_ERROR )
