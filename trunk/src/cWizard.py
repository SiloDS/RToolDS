...
class cWizard:
    ...
    def RunWizard ( self ):
        ...
        self.ROM_Path = filebrowse.DirBrowseButton ( Page1, -1, labelText = "" )
        ...
        self.Save_Path = filebrowse.DirBrowseButton ( Page2, -1, labelText = "", newDirectory=True )
...
#        Page3.sizer.Add ( wx.StaticText ( Page3, -1, _( "(It is Safe to Keep the Default)" ) ) )
        self.Image_Path = filebrowse.DirBrowseButton ( Page3, -1, labelText = "", newDirectory=True )
        ...
        self.NFO_Path = filebrowse.DirBrowseButton ( Page3, -1, labelText = "", newDirectory=True )
        self.NFO_Path.SetValue( os.path.join ( os.getcwd(), "cache", "nfo" ) )
        Page3.sizer.Add ( self.NFO_Path, 0, wx.EXPAND|wx.TOP, 10 )
        Page3.sizer.Add ( wx.StaticText ( Page3, -1, "\n" + _( "Note: Keeping the default directories is recommened.")))
        ...
        self.DLGFX = wx.RadioBox ( Page5, -1, _( 'Update RToolDS Images upon initial start-up?' ), choices = [ _( 'No' ), _( 'Yes' ) ] )
        ...
        self.Find_Unknown = wx.RadioBox ( Page6, -1, _( 'Do You Wish to Find Unknown/Homebrew ROM Files?' ), choices = [ _( 'No' ), _( 'Yes' ) ] )
        ...
        Page6.sizer.Add ( wx.StaticText( Page6, -1, _("categorized in our database. This option is recommended and is required")))
        Page6.sizer.Add ( wx.StaticText( Page6, -1, _("to detect newly released ROMs and uncategorized homebrew files." ) ) )

        Page7.sizer.Add ( wx.StaticText ( Page7, -1, _( "Select You Linker Device Drive :" ) ))
        self.Device_Path = filebrowse.DirBrowseButton ( Page7, -1, labelText = "" )
    ...
    def GetResult( self, Value ):
            if Value == "ROM_Path":
                ...
                if self.Default_Device.GetSelection() == wx.NOT_FOUND:
                    ...
                    return Config.Config ["Devices"][self.Default_Device.GetSelection()][0]
