...
class cMainFrame( wx.Frame ):
    def __init__( self, *args, **kwds ):
        ...
        global ID_MENU_PREFERENCES; ID_MENU_PREFERENCES = wx.NewId()
        ...
        wxglade_tmp_menu.AppendSeparator()
        self.Options_Menu = wx.MenuItem( wxglade_tmp_menu, ID_MENU_PREFERENCES, _( "Options" ), _( "Options" ), wx.ITEM_NORMAL )
