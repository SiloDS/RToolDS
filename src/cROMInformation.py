...
class cROMInformation( wx.Dialog ):
    def __init__( self, *args, **kwds ):
        ...
        self.Previous_Button = wx.BitmapButton( self.ROMInformation_Panel, - 1, ( GFX.catalog ["GFX_Icon_Previous16"].getBitmap() ), style = wx.BU_AUTODRAW )
        self.Next_Button = wx.BitmapButton( self.ROMInformation_Panel, - 1, ( GFX.catalog ["GFX_Icon_Next16"].getBitmap() ), style = wx.BU_AUTODRAW )
        self.View_NFO_Button = wx.BitmapButton( self.ROMInformation_Panel, - 1, ( GFX.catalog ["GFX_Icon_NFO16"].getBitmap() ), style = wx.BU_AUTODRAW )
        self.Save_Game_Button = wx.BitmapButton( self.ROMInformation_Panel, - 1, ( GFX.catalog ["GFX_Icon_SaveGamePopup16"].getBitmap() ), style = wx.BU_AUTODRAW )
        ...
        self.Label_Size = wx.StaticText( self, - 1, _( "Size : " ) )
        ...
        self.Label_Saved_Games = wx.StaticText( self, - 1, _( "Save Games : " ) )
    ...
    def __do_layout( self ):
        ...
        ROMInformation_Sizer13_copy = wx.GridSizer( 1, 2, 0, 0 )
        ...
        ROMInformation_Toolbar_Sizer.Add( self.Previous_Button, 0, wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Toolbar_Sizer.Add( self.Next_Button, 0, wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Toolbar_Sizer.Add( self.View_NFO_Button, 0, wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Toolbar_Sizer.Add( self.Save_Game_Button, 0, wx.TOP | wx.BOTTOM, 3 )
        ...
        ROMInformation_Sizer8.Add( self.Label_Icon, 0, wx.LEFT | wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer8.Add( self.Icon_Bitmap, 0, wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer7.Add( ROMInformation_Sizer8, 1, wx.EXPAND, 0 )
        ROMInformation_Sizer9.Add( self.Label_Release_Number, 0, wx.LEFT | wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer9.Add( self.Comment_Text, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 3 )
        ...
        ROMInformation_Sizer12.Add( self.Label_Title, 0, wx.LEFT | wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer12.Add( self.Title_Text, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 3 )
        ...
        ROMInformation_Sizer14.Add( self.Label_Publisher, 0, wx.LEFT | wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer14.Add( self.Publisher_Text, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 3 )
        ROMInformation_Sizer13.Add( ROMInformation_Sizer14, 1, wx.EXPAND, 0 )
        ROMInformation_Sizer25.Add( self.Label_Genre, 0, wx.LEFT | wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer25.Add( self.Genre_Text, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 3 )
        ...
        ROMInformation_Sizer15.Add( self.Label_Release_Group, 0, wx.LEFT | wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer15.Add( self.Source_ROM_Text, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 3 )
        ROMInformation_Sizer16.Add( ROMInformation_Sizer15, 1, wx.EXPAND, 0 )
        ROMInformation_Sizer15_copy.Add( self.Label_Dump_Date, 0, wx.LEFT | wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer15_copy.Add( self.Dump_Date_Text, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 3 )
        ...
        ROMInformation_Sizer26_copy.Add( self.Label_Filename, 0, wx.LEFT | wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer26_copy.Add( self.Filename_Text, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 3 )
        ROMInformation_Sizer19.Add( ROMInformation_Sizer26_copy, 1, wx.EXPAND, 0 )
        ROMInformation_Sizer26.Add( self.Label_CRC, 0, wx.LEFT | wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer26.Add( self.ROM_CRC_Text, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 3 )
        ...
        ROMInformation_Sizer28.Add( self.Label_Internal_Name, 0, wx.LEFT | wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer28.Add( self.Internal_Name_Text, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 3 )
        ROMInformation_Sizer24.Add( ROMInformation_Sizer28, 1, wx.EXPAND, 0 )
        ROMInformation_Sizer29.Add( self.Label_Serial, 0, wx.LEFT | wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer29.Add( self.Serial_Text, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 3 )
        ...
        ROMInformation_Sizer17.Add( self.Label_Size, 0, wx.LEFT | wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer17.Add( self.ROM_Size_Text, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 3 )
        ROMInformation_Sizer24_copy.Add( ROMInformation_Sizer17, 1, wx.EXPAND, 0 )
        ROMInformation_Sizer20.Add( self.Label_Location, 0, wx.LEFT | wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer20.Add( self.Location_Text, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 3 )
        ...
        ROMInformation_Sizer21.Add( self.Label_Save_Type, 0, wx.LEFT | wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer21.Add( self.Save_Type_Text, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 3 )
        ROMInformation_Sizer27.Add( ROMInformation_Sizer21, 1, wx.EXPAND, 0 )
        ROMInformation_Sizer32_copy.Add( self.Label_Saved_Games, 0, wx.LEFT | wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer32_copy.Add( self.Saved_Games_Text, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 3 )
        ...
        ROMInformation_Sizer31.Add( self.Label_Version, 0, wx.LEFT | wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer31.Add( self.Version_Text, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 3 )
        ROMInformation_Sizer13_copy.Add( ROMInformation_Sizer31, 1, wx.EXPAND, 0 )
        ROMInformation_Sizer32.Add( self.Label_Wifi, 0, wx.LEFT | wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer32.Add( self.Wifi_Text, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 3 )
        ROMInformation_Sizer13_copy.Add( ROMInformation_Sizer32, 1, wx.EXPAND, 0 )
        ROMInformation_Sizer10.Add( ROMInformation_Sizer13_copy, 1, wx.EXPAND, 0 )
        ROMInformation_Sizer23.Add( self.Label_Languages, 0, wx.LEFT | wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer23.Add( self.Language_Text, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 3 )
        ROMInformation_Sizer10.Add( ROMInformation_Sizer23, 1, wx.EXPAND, 0 )
        ROMInformation_Sizer23_copy_copy.Add( self.Label_Tags, 0, wx.LEFT | wx.TOP | wx.BOTTOM, 3 )
        ROMInformation_Sizer23_copy_copy.Add( self.Tags_Text, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 3 )
    ...
    def __LocalInit ( self ):
        ...
        if Config.Config ["Use_Trimmed"]:
            if self.ROM.Trimmed:
                ROMSize_String = _( "%s, Trimmed : %s" ) % ( Utils.Format_ROM_Size( self.ROM.ROM_Size ), Utils.Format_ROM_Size ( self.ROM.Effective_Size ) )
            else:
                ROMSize_String = _( "%s, Trimmed : N/A" ) % Utils.Format_ROM_Size( self.ROM.ROM_Size )
        else:
...
#        self.Trimmed_Size_Text.SetLabel( Trimmed )
        ...
        self.Wifi_Text.SetLabel( self.ROM.Wifi )
            
        if self.ROM.Orig_Filename == "":
            self.Filename_Text.SetLabel( _( "Unknown" ) )
        else:
