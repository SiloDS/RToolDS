...
class cOptions( wx.Dialog ):
    def __init__( self, *args, **kwds ):
        ...
        self.ROM_Path = filebrowse.DirBrowseButton(self.NotebookPanel1, -1, changeCallback = self.dbbCallback, startDirectory = Config.Config ["ROM_Path"], dialogTitle = _("Select ROM Directory") + " : ")
        self.Image_Path = filebrowse.DirBrowseButton(self.NotebookPanel1, -1, changeCallback = self.dbbCallback, startDirectory = Config.Config ["Image_Path"], dialogTitle = _("Select Screenshot Directory") + " : ")
